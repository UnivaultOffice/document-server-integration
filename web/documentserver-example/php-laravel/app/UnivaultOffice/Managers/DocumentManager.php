...
use UnivaultOffice\DocsIntegrationSdk\Manager\Document\DocumentManager as UnivaultOfficeDocumentManager;

class DocumentManager extends UnivaultOfficeDocumentManager
{
    private array $file;
