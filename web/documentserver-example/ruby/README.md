...
This example will help you integrate UNIVAULTOFFICE Docs into your web application written on Ruby.
...
```sh
$ curl --output Ruby.Example.zip --location https://github.com/UnivaultOffice/document-server-integration/releases/latest/download/Ruby.Example.zip
