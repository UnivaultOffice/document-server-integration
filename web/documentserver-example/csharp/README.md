...
This example will help you integrate UNIVAULTOFFICE Docs into your web application written in .Net (C#).
...
Download the [.Net (C#) example](https://api.univaultoffice.github.io/editors/demopreview) from our site.
...
Open the *settings.config* file and [specify the same secret key](https://helpcenter.univaultoffice.github.io/installation/docs-configure-jwt.aspx) as used in your Document Server to enable JWT: 
