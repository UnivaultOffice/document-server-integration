...
This example will help you integrate UNIVAULTOFFICE Docs into your web application written on Python.
...
```sh
$ curl --output Python.Example.zip --location https://github.com/UnivaultOffice/document-server-integration/releases/latest/download/Python.Example.zip
...
By default, the server starts at `0.0.0.0:2025`.
...
| `DOCUMENT_SERVER_PRIVATE_URL` | The URL through which the server will communicate with Document Server. | `http://proxy:2025`     |
| `DOCUMENT_SERVER_PUBLIC_URL`  | The URL through which a user will communicate with Document Server.     | `http://localhost:2025` |
